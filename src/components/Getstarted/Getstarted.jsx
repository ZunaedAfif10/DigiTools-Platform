...
export const Getstarted = () => {
  return (
    <div className='mt-32 pb-32 text-center bg-[#F9FAFC]'>
        ...
        <div className='container mx-auto grid lg:grid-cols-3 gap-8 pt-3.5'>
            <div className='rounded-xl relative bg-white p-20 space-y-6'>
            ...
            <div className='rounded-xl relative bg-white p-20 space-y-6'>
                <p className='absolute top-5 right-5 rounded-full bg-blue-700 px-4 py-3.5 text-white'>02</p>
            ...
            <div className='rounded-xl relative bg-white p-20 space-y-6'>
                <p className='absolute top-5 right-5 rounded-full bg-blue-700 px-4 py-3 text-white'>03</p>
